...
const HeroSection = ({
  ...
  return <section className="relative min-h-[calc(100vh-80px)] flex flex-col items-center justify-center py-10 md:py-20 px-4">
      ...
      <div className="container max-w-6xl mx-auto text-center relative z-10">
        ...
        stiffness: 100
          ...
          <motion.h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-4 md:mb-6 leading-tight max-w-4xl mx-auto" variants={{
          hidden: {
            opacity: 0
          },
          visible: {
          ...
          <motion.p className="text-lg sm:text-xl md:text-2xl text-gray-300 mb-8 md:mb-12 max-w-3xl mx-auto" initial={{
          opacity: 0
        }} animate={{
          opacity: 1
        }} transition={{
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            delay: 0.9
              ...
              <Button size="lg" onClick={scrollToScanner} className={cn("text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 bg-bscamber hover:bg-bscamber-light text-black font-medium w-full sm:w-auto", "transition-all duration-300 shadow-lg hover:shadow-bscamber/20 hover:shadow-xl")}>
                Scan a token
              </Button>
            </motion.div>
            <motion.div initial={{
